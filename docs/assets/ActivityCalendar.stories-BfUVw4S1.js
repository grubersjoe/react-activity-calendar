const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Tooltip-DRiiSyHr.js","./chunk-BneVvdWh.js","./iframe-C6Ygjoiw.js","./preload-helper-CV6hqhE5.js","./react-CRjV-JFB.js","./components-BnODNKbX.js","./theming-Bd78xjo2.js","./iframe-BJpTEOw-.css"])))=>i.map(i=>d[i]);
import{a as e,n as t}from"./chunk-BneVvdWh.js";import{n,t as r}from"./preload-helper-CV6hqhE5.js";import{_ as i,p as a,tt as o,v as s}from"./iframe-C6Ygjoiw.js";import{i as c,n as l,r as u,t as d}from"./Source-BUWCd34A.js";import{_ as ee,a as f,c as te,d as ne,f as re,g as ie,h as ae,i as p,l as oe,m as se,n as ce,o as le,p as m,r as ue,s as h,u as de}from"./Tooltip-DRiiSyHr.js";var g,_,fe=t((()=>{g=a(),_=({children:e})=>(0,g.jsx)(`div`,{style:{margin:`1rem 0 2rem`},children:e}),_.__docgenInfo={description:``,methods:[],displayName:`Container`,props:{children:{required:!0,tsType:{name:`ReactNode`},description:``}}}})),pe,me=t((()=>{pe=`<ActivityCalendar
  data={data}
  blockSize={14}
  blockRadius={7}
  blockMargin={5}
