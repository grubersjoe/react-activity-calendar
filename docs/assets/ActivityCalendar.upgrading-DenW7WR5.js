import{j as e,M as d}from"./iframe-CNPHK4yY.js";import{useMDXComponents as i}from"./index-CJXQJM-7.js";import{S as t,r}from"./Source-YmYwiCzP.js";import"./preload-helper-PPVm8Dsz.js";function s(o){const n={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...i(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"React Activity Calendar/Upgrading to v3"}),`
...
`,e.jsx(t,{code:"import { ActivityCalendar } from 'react-activity-calendar'"}),`
`]}),`
...
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"<Skeleton />"})," component has been ",e.jsx(n.strong,{children:"removed"}),".",e.jsx("br",{}),` Render the calendar in its loading state
instead:`,`
`,e.jsx(t,{code:"<ActivityCalendar loading />"}),`
`]}),`
`]}),`
...
and examples.`]})]})}function p(o={}){const{wrapper:n}={...i(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(s,{...o})}):s(o)}export{p as default};
