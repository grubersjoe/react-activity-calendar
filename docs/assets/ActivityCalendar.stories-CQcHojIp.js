const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Tooltip-CPGKkW4E.js","./rolldown-runtime-DaJ6WEGw.js","./react-BJoyWkjz.js","./react-dom-BszNnTUp.js","./jsx-runtime-cM__dR4X.js"])))=>i.map(i=>d[i]);
import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{n,t as r}from"./preload-helper-si3HNj2m.js";import{t as i}from"./react-BJoyWkjz.js";import{t as a}from"./jsx-runtime-cM__dR4X.js";import{n as o,t as s}from"./iframe-DYSLgZfc.js";import{i as c,n as l,r as u,t as d}from"./Source-DhLRnZeL.js";import{_ as ee,a as f,c as te,d as p,f as ne,g as re,i as m,l as ie,m as h,n as ae,o as oe,p as g,r as se,s as _,u as ce,y as le}from"./Tooltip-CPGKkW4E.js";var v,y,ue=t((()=>{v=a(),y=({children:e})=>(0,v.jsx)(`div`,{style:{margin:`1rem 0 2rem`},children:e}),y.__docgenInfo={description:``,methods:[],displayName:`Container`,props:{children:{required:!0,tsType:{name:`ReactNode`},description:``}}}})),de,fe=t((()=>{de=`<ActivityCalendar
  data={data}
  minLevel={-6}
  maxLevel={3}
  labels={{
