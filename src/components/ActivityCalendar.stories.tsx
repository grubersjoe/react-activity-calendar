  ...
  render: args => {
    ...
    return (
      <Container>
        ...
        <ActivityCalendar {...args} data={data} style={{ margin: '2rem 0' }} />
        <p>
          Tooltips are "headless" and have no styles attached, so you can style them according to
          your needs like below. If you do not need this flexibility you can import the provided CSS
          file that contains default styling.
        </p>
        <Source
