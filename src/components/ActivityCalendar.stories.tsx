...
import exampleCustomization from '../docs/examples/customization?raw'
import exampleEventHandlers from '../docs/examples/event-handlers?raw'
import exampleLabelsShape from '../docs/examples/labels-shape?raw'
import exampleLabels from '../docs/examples/labels?raw'
import exampleRef from '../docs/examples/ref?raw'
import exampleThemeExplicit from '../docs/examples/themes-explicit?raw'
import exampleTheme from '../docs/examples/themes?raw'
import exampleTooltipsConfig from '../docs/examples/tooltips-config?raw'
import exampleTooltips from '../docs/examples/tooltips?raw'
