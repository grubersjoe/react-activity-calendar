...
describe('getMonthLabels', () => {
  ...
  test('skips first month labels if it does not contain at least two full weeks', () => {
    const weeks = groupByWeeks(
      generateData({
  ...
  test('skips last month labels if it does not contain at least two full weeks', () => {
    const weeks = groupByWeeks(
      generateData({
